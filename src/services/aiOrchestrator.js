...
class AIOrchestrationService {
  ...
  _handleOrchestrationError(error, analysis) {
    const enhancedError = new Error(`Project Crew AI processing failed: ${error.message}`);
  ...
  logTaskMetrics(metrics) {
    console.log('[Project Crew AI] Task Metrics:', JSON.stringify(metrics));
  ...
  _enhanceError(error, context) {
    const enhancedError = new Error(`Project Crew AI failed to process chat message: ${error.message}`);
